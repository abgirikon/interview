...
export const modalPopUpStyleLarge = {
  position: 'absolute',
  top: '50%',
  left: '50%',
  transform: 'translate(-50%, -50%)',
      ...
      MuiButtonBase: {
        ...
        styleOverrides: {
          root: {
            ...
            '&:focus-visible': {
              outline: `3px solid ${alpha(brand[300], 0.5)}`,
              outlineOffset: '2px',
            },
          },
        },
      ...
      MuiButton: {
        styleOverrides: {
          root: ({ theme, ownerState }) => ({
            ...
            ...(ownerState.colorStyle === 'cancel' && {
              '&': {
                color: `${error[200]} !important`,
              },
              backgroundColor: alpha(error[100], 0.1),
              '&:hover': {
                backgroundColor: `${alpha(error[800], 0.1)} !important`,
                borderColor: `${error[500]} !important`,
                '&:hover span': {
                  color: `${error[800]} !important`,
                },
              },
              '&:hover:hover': { 
                backgroundColor: `${alpha(error[800], 0.1)} !important`,
            ...
            ...(ownerState.colorStyle === 'gray' && {
              '&': {
                color: `${gray[600]} !important`,
              },
              backgroundColor: alpha(gray[700], 0.1),
              '&:hover': {
                backgroundColor: `${alpha(gray[700], 0.1)} !important`, 
              ...
              '&:hover:hover': { 
                backgroundColor: `${alpha(gray[900], 0.1)} !important`,
                borderColor: `${gray[500]} !important`,
              },
            }),

            ...(ownerState.colorStyle === 'primary' && {
              '&': {
                color: `${primary[300]} !important`,
              },
              backgroundColor: alpha(primary[500], 0.1),
              '&:hover': {
                backgroundColor: `${alpha(primary[700], 0.1)} !important`,
              ...
              '&:hover:hover': { 
                backgroundColor: `${alpha(primary[800], 0.1)} !important`,
                borderColor: `${primary[500]} !important`,
              },
              '&[disabled]': { // Styles for the disabled state
                opacity: 0.5, // Example: Reduce opacity for a disabled look
                pointerEvents: 'none', // Example: Disable pointer events
            ...
            ...(ownerState.variant === 'contained' &&
              ownerState.color === '' && {
                ...
                '&:hover': {
                  ...
                  boxShadow: `0 0 0 1px  ${alpha(gray[300], 0.5)}`,
                },
              }),
            ...
            ...(theme.palette.mode === 'dark' && {
              ...
              ...(ownerState.buttonStyle === 'cancel' && {
                color: error[100],
                '&:hover': {
                  backgroundColor: alpha(error[100], 0.3),
                  borderColor: brand[700],
                },
              }),
            }),
      ...
      MuiCard: {
        styleOverrides: {
          root: ({ theme, ownerState }) => ({
           ...
           // boxShadow: '0 0 0 2px  ${alpha(gray[300], 0.5)}',
